...
class CollectionsTest < ApplicationSystemTestCase
  ...
  test "should create collection" do
    ...
    fill_in "Collection", with: @collection.collection_id
    fill_in "Description", with: @collection.description
    fill_in "Numberofcourses", with: @collection.numberofcourses
    fill_in "Numberofreviews", with: @collection.numberofreviews
    fill_in "Price", with: @collection.price
